...
This example uses the `trip` dataset to explore the relationship between trip
distance and trip duration. This is a useful intro statistics example because it
uses one quantitative explanatory variable and one quantitative outcome
variable.
