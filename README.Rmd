...
-   `tripaccess`: tripaccess, constructed from the NHTS 2017 person and trip files, includes disability and other demographic as well as mobility and trip categorical and numeric variables. It has 86,521 rows (each row is a person) and 40 columns. It can be used for data visualization, single table data wrangling, exploratory data analysis (EDA), group comparisons, and categorical data analysis.
