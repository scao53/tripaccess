...
This data package is suitable for data visualization, data wrangling, joining datasets, exploratory data analysis (EDA), group comparisons, simple linear regression, and categorical data analysis in data science and statistics classes.
