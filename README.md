...
This data package contains subsets from the [National Household Travel
Survey (NHTS)](https://nhts.ornl.gov/) 2017 person, house, and trip
files. It includes personal trips, mobility, demographic, and household
information.

## Installation

You can install the development version of tripaccess from
...
- `tripaccess`: tripaccess, constructed from the NHTS 2017 person and
  ...
  mobility and trip categorical and numeric variables. It has 86521 rows
  (each row is a person) and 40 columns. It can be used for data
  visualization, single table data wrangling, exploratory data analysis
  (EDA), group comparisons, and categorical data analysis.
- `person`: person, constructed from the NHTS 2017 person file, includes
  ...
  variables. It has 99564 rows (each row is a person) and 32 columns. It
  can be used for data visualization, single table analysis, EDA, group
  comparisons, and categorical data analysis. It can also be used
...
- `house`: house, constructed from the NHTS 2017 house file, includes
  ...
  129695 rows (each row is a household) and 9 columns. It can be used
...
- `trip`: trip, constructed from the NHTS 2017 trip file, includes trip
  related categorical and numeric variables. It has 921590 rows (each
